...
class ElasticCommonSchemaFormatterTest extends BaseTestCase
{
    ...
    {
        $msg = new LogRecord(new \DateTimeImmutable("@0"), 'ecs', Level::Info, md5(uniqid()), [], []);
    ...
    public function testTimezone()
    {
        ...
        $msg = new LogRecord(
            new DateTimeImmutable('2013-11-28T12:34:56.98765', new DateTimeZone('-03:45')),
            'ecs',
            Level::Info,
            md5(uniqid()),
            [],
    ...
    public function testContextWithError(Throwable $throwable, bool $shouldWrap): void
    {
        $msg = new LogRecord(
            ...
            Level::Error,
            md5(uniqid()),
            ['error' => $shouldWrap ? new Error($throwable) : $throwable],
            []
        );
    ...
    public function testServiceNamePerLogger()
    {
        ...
        $testHelper->expectedLogLevel = Level::Warning;
